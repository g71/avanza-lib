    ...
    return new Promise((resolve, reject) => {
      ...
      request({
        ...
        .then(response => {
          ...
          if (typeof response.data.twoFactorLogin === 'undefined') {
            return Promise.resolve(response)
          }
          const tfaOpts = response.data.twoFactorLogin
        ...
        .then(response => {
          ...
          this._pushSubscriptionId = response.data.pushSubscriptionId
          this._customerId = response.data.customerId
          ...
          debug('authenticated', this._securityToken)
          resolve({
